          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {productCategories.map((p) => (
              <Link
                key={p.slug}
                href={`/urunler/${p.slug}`}
                className="group block rounded-2xl border border-border bg-card hover:bg-card/80 hover:border-[var(--brand-orange)]/40 transition-all p-6 sm:p-8 relative overflow-hidden"
              >
